...
class MainMenu extends Menu
{
    ...
    public function render(): void
    {
        ...
        $this->getInventory()->setContents([
            ...
            15 => VanillaItems::GOLD_INGOT()->setCustomName(PiggyAuctions::getInstance()->getMessage("menus.main-menu.manage-auctions")),
            26 => StringToItemParser::getInstance()->parse("paper")->setCustomName(PiggyAuctions::getInstance()->getMessage("menus.main-menu.auction-stats"))
        ]);
    }
}